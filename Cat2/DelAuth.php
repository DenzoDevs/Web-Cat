...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['deleteAuthor'])) {
    try {
        ...
        $stmt = $conn->prepare("DELETE FROM authortb WHERE author_id = :author_id");
...
<head>
    ...
    <title>We Write- Delete Author</title>
...
<body>
    ...
    <?php if (isset($author)) : ?>
        <form action="DelAuth.php" method="POST">
            ...
            <p>Are you sure you want to delete the author "<?php echo $author['Author_full_name']; ?>"?</p>
